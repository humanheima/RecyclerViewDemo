...
import kotlinx.android.synthetic.main.activity_recycler_view_time_line.*
import java.util.*
            ...
            override fun bindViewHolder(holder: BaseViewHolder, testBean: TestBean, position: Int) {
                if (holder.itemViewType == R.layout.item_diff) {
                    ...
                    holder.setOnItemClickListener(R.id.iv) { _, pos ->
                        Toast.makeText(this@RecyclerViewTimeLineActivity,
                                "onItemClick position=$pos", Toast.LENGTH_SHORT).show()
                    }
                }
            }
        }
