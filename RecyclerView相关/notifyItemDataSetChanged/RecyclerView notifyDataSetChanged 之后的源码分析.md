...
回到 RecyclerView.RecyclerViewDataObserver 的 onChanged 方法注释3处，调用 requestLayout() 后，会触发调用dispatchLayout方法。
...
注释1处，获取下一个View。在我们这个例子中，是从 RecyclerViewPool 中获取的，还有新创建的。
